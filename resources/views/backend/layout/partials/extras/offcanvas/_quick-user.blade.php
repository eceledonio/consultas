    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                <a href="{{ route('admin.user.account') }}" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">
					{{ $logged_in_user->name }}
				</a>

                <div class="navi mt-2">
                    <a href="mailto:{{ $logged_in_user->email }}" class="navi-item" target="_blank">
		...
		<div class="navi navi-spacer-x-0 p-0">
		    {{-- Item --}}
		    <a href="{{ route('admin.user.account') }}" class="navi-item">
		        <div class="navi-link">
            ...
            {{-- Item --}}
            <a href="{{ route('frontend.auth.logout') }}" class="navi-item">
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
                            {{ Metronic::getSVG("media/svg/icons/Navigation/Arrow-to-bottom.svg", "svg-icon-md svg-icon-primary") }}
                        </div>
                    </div>
