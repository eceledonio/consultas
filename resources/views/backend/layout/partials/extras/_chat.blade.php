        ...
        <div class="modal-content">
            ...
            <div class="card card-custom">
                            ...
                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-md">
                                ...
                                <ul class="navi navi-hover py-5">
                                    <li class="navi-item">
                                        <a href="#" class="navi-link">
                                            <span class="navi-icon">
                                                <i class="navi-icon flaticon2-group"></i>
                                            </span>
                                    ...
                                    <li class="navi-item">
                                        <a href="#" class="navi-link">
                                            <span class="navi-icon">
                                                <i class="navi-icon flaticon2-rocket-1"></i>
                                            </span>
                                    ...
                                    <li class="navi-item">
                                        <a href="#" class="navi-link">
                                            <span class="navi-icon">
                                                <i class="navi-icon flaticon2-bell-2"></i>
                                            </span>
                                    ...
                                    <li class="navi-item">
                                        <a href="#" class="navi-link">
                                            <span class="navi-icon">
                                                <i class="navi-icon flaticon2-dashboard"></i>
                                            </span>
                                    ...
                                    <li class="navi-item">
                                        <a href="#" class="navi-link">
                                            <span class="navi-icon">
                                                <i class="navi-icon flaticon2-protected"></i>
                                            </span>
                ...
                <div class="card-footer align-items-center">
                    {{-- Compose --}}
                    <textarea class="form-control border-0 p-0" rows="2" placeholder="{{ __('Escribe un mensaje...') }}"></textarea>
