...
return [
    ...
    */
    'access' => [
        ...
        'user' => [
             ...
             * which will force a record into the password_histories table.
             */
        ...
        'role' => [
            /*
             * The name of the super administrador role
             * Should be Super Administrador by design and unable to change from the backend
             * It is not recommended to change
             */
            'super_admin' => 'Super Administrador',

            /*
             * The name of the administrador role
             * Should be Administrador by design and unable to change from the backend
             * It is not recommended to change
             */
            'admin' => 'Administrador',
        ...
        // Wether or not login with socialite is enabled
        'socialite' => env('ENABLE_SOCIALITE', true),

        // Wether or not Laravel Telescope is enabled
    ...
    */
    ...
    'routes' => [
         ...
         */
        'debug_only' => env('DEBUGBAR_ENABLED'),
